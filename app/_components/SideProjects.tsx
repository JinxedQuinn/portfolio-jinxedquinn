...
export const SIDE_PROJECTS: SideProjectsProps[] = [
  ...
  },
  {
    Logo: ChefHat,
    title: "Le Fou Frog",
    description: "Projet de site web pour un restaurant français aux États-Unis. Codé avec Ryo Rafael, propriétaire du projet",
    url: "https://github.com/ryorafael/lefoufrog",
  },
  {
    Logo: Beer,
    title: "La Mutinerie",
    description: "J'ai choisi de mon plein gré, de refaire le site de la Mutinerie",
  ...
  },
{
    ...
    description: "Une extension navigateur qui sert à calculer le taux de change monétaire",
  ...
  },
{
    ...
    description: "Une boîte à suggestions pour que les étudiant.e.s puissent s'exprimer anonymement",
